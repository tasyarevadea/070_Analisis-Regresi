...
data <- read_excel("C:\\Users\\Tasya\\OneDrive\\Documents\\Kuliah\\Semester 4\\Analisis Regresi\\Pertemuan 2\\NSC-2025_Tasya Revadea Putri.xlsx", sheet="Sheet2")
...
Saat ini terdapat 1 peubah Y dan 9 peubah X, misal ingin dilakukan eksplorasi dan analisis terkait peubah X8
...
Nilai p lebih dari alpha 0.05 sehingga secara simultan X dan Y tidak saling berpengaruh signifikan
...
$$\hat{Y} = 109.11880 - 0.46621 X_8$$

dengan Y adalah indeks pembangunan manusia dan X adalah tingkat partisipasi angkatan kerja.

Didapatkan nilai $\hat\beta_0 = 109.11880$ artinya nilai dugaan rataan indeks pembangunan manusia ketika tingkat partisipasi angkatan kerja bernilai 0 adalah 109.119, akan tetapi nilai 0 tidak ada dalam selang pengamatan tingkat partisipasi angkatan kerja sehingga $\hat\beta_0$ tidak dapat didefinisikan lebih lanjut

Nilai $\hat\beta_1 = - 0.46621$ artinya nilai dugaan perubahan dugaan rataan Indeks Pembangunan Manusia jika tingkat partisipasi angkatan kerja berubah satu tahun adalah sebesar -4.662%

Koefisien determinasi yang dihasilkan adalah 0.1887 atau 18.87% artinya indeks pembangunan manusia yang dapat dijelaskan oleh tingkat partisipasi angkatan kerja adalah sebesar 18.87%, sisanya yaitu 91.13% dijelaskan oleh peubah lain yang tidak dimasukkan dalam model.
