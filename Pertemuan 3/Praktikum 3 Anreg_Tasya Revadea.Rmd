...
```{r}
library(readxl)
dt <- read_xlsx("~/Kuliah/Semester 4/Analisis Regresi/Data baseball.xlsx")
head(dt)
...
harapan dari peubah respons Y (Wins)

$$E[\hat{Y}] = \hat{Y} = 215.98221 - 0.10470 X$$
...
bernilai 2417.3 dan JKG model bernilai 1550.7
...
55.38048. Hubungan antara keduanya dapat dituliskan sebagai berikut.
...
$S_e = \sqrt{55.38048} \approx 7.441807$
...
parameter β0 dan β1 sebesar 215.9822 dan -0.1046969. Kedua nilai dugaan
...
kepercayaan untuk parameter $β_0$ adalah [162.9678 ,  268.9966] dan untuk
parameter $β_1$ adalah [-0.1454325 ,  -0.06396129]
...
individu Y ketika nilai x=1300 adalah 79.87625. Selain itu, diindikasikan
juga bahwa dalam taraf kepercayaan 95%, diyakini bahwa nilai amatan
individu Y ketika nilai x=1300 berada dalam selang 64.37651 hingga
95.376.
